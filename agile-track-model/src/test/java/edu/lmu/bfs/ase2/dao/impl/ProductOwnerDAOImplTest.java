...
import edu.lmu.bfs.ase2.model.ProductOwner;
 ...
 * 
 */
public class ProductOwnerDAOImplTest {
	...
	public void testCreateUser() {
		...
		ProductOwner user = new ProductOwner();
	...
	public void testGetByUsername() {
		...
		// Call the DB Method
		ProductOwner tm = new ProductOwner();
		tm = (ProductOwner) dao.getUserByUsername(user.getUsername());
	...
	public void testGetUsersByRole() {
		...
		List<ProductOwner> users = (List<ProductOwner>) dao.getUsersByRole(user
				.getRole());
