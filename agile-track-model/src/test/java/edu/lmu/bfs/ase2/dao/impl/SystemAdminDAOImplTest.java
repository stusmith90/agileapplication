...
import edu.lmu.bfs.ase2.model.SystemAdmin;
 ...
 * 
 */
public class SystemAdminDAOImplTest {
	...
	public void testGetByUsername() {
		...
		// Call the DB Method
		SystemAdmin tm = new SystemAdmin();
		tm = (SystemAdmin) dao.getUserByUsername(user.getUsername());
	...
	public void testGetUsersByRole() {
		...
		List<SystemAdmin> users = (List<SystemAdmin>) dao.getUsersByRole(user
				.getRole());
