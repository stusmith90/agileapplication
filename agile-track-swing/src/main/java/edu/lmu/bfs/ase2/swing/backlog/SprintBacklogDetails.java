...
public class SprintBacklogDetails extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SprintBacklogDetails frame = new SprintBacklogDetails(mockProductBacklog());
	 ...
	 * Create the frame.
	 */
	public SprintBacklogDetails(final Backlog backlog) {
		...
		Action editAction = new AbstractAction()
		{
			...
			public void actionPerformed(ActionEvent e)
		    {
		        ...
		        // TODO PLUG INTO USER STORY DETAILS WINDOW
		    }
		};
